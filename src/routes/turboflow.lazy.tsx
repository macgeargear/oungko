...
import TurboNode, { TurboNodeData } from "../components/flow/TurboNode";
import TurboEdge from "../components/flow/TurboEdge";
import FunctionIcon from "../components/flow/FunctionIcon";
...
export const Route = createLazyFileRoute("/turboflow")({
  component: Flow,
});
